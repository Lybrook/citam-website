  ...
  const ministries: Ministry[] = [
    {
      ...
      description:
        "Empowering young people to live for Christ and make a difference in their generation.",
      image: "/youthMinistry.jpg",
      anchor: "youth",
    },
    {
      ...
      description:
        "Creating a fun and nurturing environment where children learn about God's love.",
    ...
    },
    {
      ...
      description:
        "Extending God's love through service and support to our local community.",
      image: "/pastor2.jpg",
      anchor: "outreach",
    },
  ];
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='keywords'
          content='CITAM, Christ is The Answer Ministries, church in Kitale, Christian fellowship, worship, Kitale church'
        />
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-10 items-center'>
            <div>
              ...
              <p className='text-lg mb-6 text-gray-800'>
                Christ is The Answer Ministries (CITAM) Kitale is a vibrant
                church dedicated to sharing the love of Christ and making
                disciples in Kitale and beyond. Our mission is to know God and
                make Him known through worship, fellowship, and service.
              </p>
              <p className='text-lg mb-6 text-gray-800'>
                Whether you are exploring faith for the first time or looking
                for a church to call home, we invite you to join us this Sunday
                for an inspiring message and heartfelt worship experience.
              </p>
              <p className='text-lg mb-6 text-gray-800'>
                Join us for a special event on Sunday, &apos;Family Day&apos;!
              </p>
          ...
          <div className='max-w-4xl mx-auto'>
            <blockquote className='text-center'>
              <p className='text-xl md:text-2xl italic mb-6'>
                CITAM Kitale has been a blessing to my family. The childrens
                ministry has helped my kids grow spiritually, and the worship
                experience is always uplifting.
              </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "CITAM Kitale is a vibrant church dedicated to sharing the love of Christ and making disciples in Kitale and beyond.",
            address: {
              "@type": "PostalAddress",
