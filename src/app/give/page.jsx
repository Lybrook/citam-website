                ...
                <section className="container mx-auto px-4">
                    ...
                    <form className="space-y-4">
                        <div>
                            ...
                            <input type="number" id="amount" className="w-full p-2 border border-gray-300 rounded" required />
                        </div>
                        <div>
                        ...
                        <button type="submit" className="bg-primary text-white px-4 py-2 rounded">Donate</button>
                    </form>
                </section>
            </main>
            <Footer />
