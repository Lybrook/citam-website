...
import { Card, CardContent } from "../../components/ui/card"; // Import CardContent explicitly
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Mission Card */}
            <Card className="shadow-lg border-t-4 border-red-600 hover:shadow-xl hover:scale-105 transition-all duration-300">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button
              asChild
              size="lg"
              className="bg-white text-red-600 hover:bg-gray-100 hover:scale-105 transition-transform duration-200"
            >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-white text-white hover:bg-red-700 hover:scale-105 transition-transform duration-200"
            >
